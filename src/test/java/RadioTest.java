...
public class RadioTest {
    ...
    @Test
    public void test() {
        Radio radioChannel = new Radio(10, 9);
        Assertions.assertEquals(10, radioChannel.getCountChannel());  //проверка количества каналов
        Assertions.assertEquals(10, radioChannel.getCurrentVolume());  //проверка установки максимального канала
    ...
    @Test
    public void testw(){
        Radio radioVolume = new Radio (90);
        Assertions.assertEquals(91, radioVolume.getCurrentVolume());
    }
